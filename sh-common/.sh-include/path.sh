...
[ -z "$APS_PATH" ] && export APS_PATH="$HOME/.dotfiles/bin:$HOME/.toolbox/bin:/usr/local/bin:/usr/local/sbin:/usr/local/heroku/bin:$ANDROID_HOME/tools:$ANDROID_HOME/platform-tools"
