...
(defun color-theme-helvetica ()
  ...
  (color-theme-install
   '(color-theme-helvetica
     ...
     (bold ((t (:bold t :foreground "#d90000" :weight bold :family "Helvetica Neue"))))
...
;;      (modeline ((t (:background "#3c3c3c" :foreground "#777777" ))))
     (modeline ((t (:background "#282828" :foreground "#777777" ))))
...
;;      (modeline-inactive ((t (:background "#444444" :foreground "#505050"))))
     (modeline-inactive ((t (:background "#3B3B3B" :foreground "#505050"))))
